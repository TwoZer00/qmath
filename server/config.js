...
const GRACE_ROUNDS = parseInt(process.env.GRACE_ROUNDS) || 3;

module.exports = { MIN_PLAYERS, MAX_PLAYERS, MAX_VOTE_ROUNDS, TIME_LIMIT, LOBBY_WAIT, VOTE_WAIT, RESTART_WAIT, ROUND_WAIT, BOT_ERROR_RATE, GRACE_ROUNDS };
